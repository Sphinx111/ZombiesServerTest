...
public enum Type {
  ...
  float ZOMBIE_MAXSPEED_MULTIPLIER = 0.98;
  ...
  float BIGZOMBIE_MAXSPEED_MULTIPLIER = 0.90;
...
public enum WeaponType {
  ...
  int RIFLE_DAMAGE = 15;
  float RIFLE_PUSHBACK = 250; //remember, this value is improved by the fire rate.
